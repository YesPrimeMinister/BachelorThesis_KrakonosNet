...
folder = 'krakonosnet_jes_spectarea_1e-5_2bit_3class_tree90percent'
spatial_res = 0.58
...
def georeference_folder(ref_path, pred_path):
    ...
    out_dataset = arcpy.CreateRasterDataset_management(reference_path + 'complete\\', out_filename, pixel_type='2_BIT', number_of_bands=1, pyramids= 'NONE')
